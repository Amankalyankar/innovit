...
const translations = {
    en: {
        ...
        'hero.subtitle': 'Access village services, track budgets, and report issues directly from your phone or computer.',
    ...
    hi: {
        ...
        'hero.subtitle': 'ग्राम सेवाओं तक पहुंचें, बजट ट्रैक करें और सीधे अपने फ़ोन से समस्याओं की रिपोर्ट करें।',
        ...
        'services.certificatesDesc': 'जन्म, मृत्यु और आय प्रमाण पत्र के लिए आवेदन करें।',
...
function initAnimations() {
    ...
    const animateElements = document.querySelectorAll('.service-card, .portal-card, .win-item');
...
function handleVote(issueId, vote) {
    ...
    showNotification(vote === 'yes' ? 'Vote recorded! Thank you for participating.' : 'Vote recorded.', 'success');
}
